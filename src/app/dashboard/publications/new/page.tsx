...
export default function NewPublicationPage() {
  ...
  return (
    <main className="flex-1 px-4 sm:px-8 py-6 sm:py-8 max-w-4xl">
      ...
      <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-1">New Publication Article</h1>
      <p className="text-sm text-gray-500 mb-6 sm:mb-8">
        Write a new publication or article to publish on the Research &amp; Publications page.
      </p>

      <form action={action} className="space-y-6 bg-white border border-gray-100 shadow-sm p-4 sm:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField label="Title" name="title" required>
            <input
              ...
              placeholder="e.g. Pan-African AI Governance: Building Ethical Frameworks"
          ...
          <FormField
            label="URL Slug"
            name="slug"
            hint="Auto-generated URL identifier for /research/[slug]"
          >
            <input
              id="slug"
              name="slug"
              ...
              placeholder="pan-african-ai-governance"
              className={inputClass}
            />
          </FormField>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <FormField
            ...
            name="source_label"
            hint="e.g. HIKMA AI Policy Group"
          >
            <input
              id="source_label"
              name="source_label"
              type="text"
              placeholder="e.g. HIKMA AI Policy Group"
              className={inputClass}
            />
          </FormField>
        ...
        <FormField
          ...
          name="excerpt"
          required
          hint="Short summary shown on the research page card (2–3 sentences)."
        >
          <textarea
            id="excerpt"
            name="excerpt"
        ...
        <FormField
          ...
          name="content_editor"
          hint="Write the full article body using the rich text editor below."
        >
          <RichTextEditor
