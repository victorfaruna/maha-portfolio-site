          ...
          <div className="lg:col-span-4 relative">
            ...
            >
              ...
              <h2 className="text-5xl md:text-6xl text-foreground font-medium tracking-tight leading-[1.1] mb-6">
                Professional <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-br from-foreground via-foreground/80 to-accent">Journey</span>
              </h2>
              <p className="text-lg text-muted-foreground">
                A timeline of my dedication to advancing AI policy and representation globally.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-8 relative">
            ...
            <div className="space-y-12">
              {experiences.map((exp, idx) => (
                ...
                >
                  {/* Glowing Node */}
                  <div className="absolute left-[-5px] md:left-[31px] top-8 w-4 h-4 rounded-full bg-background border-2 border-accent shadow-[0_0_15px_rgba(255,0,0,0.5)] hidden sm:block transition-transform duration-500 group-hover:scale-150" />

                  <div className="relative overflow-hidden rounded-2xl bg-secondary/30 backdrop-blur-md border border-white/10 p-8 shadow-md hover:shadow-lg transition-all duration-500 hover:-translate-y-2">
                    {/* Hover Glow */}
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                      <div className="md:w-1/3">
                        ...
                        <h3 className="text-2xl font-serif text-foreground group-hover:text-accent transition-colors duration-300">
                          {exp.title}
                        </h3>
                      </div>
